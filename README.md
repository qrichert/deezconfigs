...
[![GitHub Tag](https://img.shields.io/github/v/tag/qrichert/deezconfigs?sort=semver&filter=*.*.*&label=release)](https://github.com/qrichert/deezconfigs/releases/latest)
...
```console
# Run your editor inside the root.
$ deez run $EDITOR

# Start an interactive shell inside the root.
$ deez run $SHELL
